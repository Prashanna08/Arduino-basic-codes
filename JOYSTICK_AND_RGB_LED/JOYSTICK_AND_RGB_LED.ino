...
void loop() 
{
  ...
  int brightRed = constrain(map(distanceRed, 0, 1023, 0, 255), 0, 255);
  int brightGreen = constrain(map(distanceGreen, 0, 1023, 0, 255), 0, 255);
  int brightBlue = constrain(map(distanceBlue, 0, 1023, 0, 255), 0, 255);
